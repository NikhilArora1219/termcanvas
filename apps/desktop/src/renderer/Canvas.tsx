...
import './Canvas.css';
import type { AgentNodeData } from '@termcanvas/shared';
import { createDefaultAgentTitle, useExpose } from '@termcanvas/shared';
    ...
    <NodeActionsProvider onNodesChange={handleNodeActionsChange}>
      ...
      >
        ...
        <div className={`canvas-content ${sidebar.isSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
          ...
          {/* ReactFlow wrapper — position:absolute gives real pixel dimensions */}
            ...
            <div style={{ position: 'absolute', inset: 0 }}>
              ...
              >
                <Background
                  ...
                  size={2}
                  color={
                    theme === 'light-web' ? '#F5F6F8' : theme === 'dark' ? '#171717' : '#3a3a3a'
                  }
                />
                <ForkGhostNode />
              </ReactFlow>
